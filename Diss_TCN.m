...
for i = 1:length(arquivos)
    ...
    if all(ismember(required_columns, dados.Properties.VariableNames))
        ...
        % --- Combinação dos dados dos dois pés ---
...
% --- Normalização Z-score da saída (vGRF) ---
...
writetable(metricas_tabela, 'metricas_TCN_vGRF_RL.csv');
disp('Métricas salvas no arquivo "metricas_TCN_vGRF_RL.csv".');

% Salvar modelo
save('modelo_TCN_vGRF_RL.mat', 'net');
disp('Modelo treinado salvo como "modelo_TCN_vGRF_RL.mat".');
